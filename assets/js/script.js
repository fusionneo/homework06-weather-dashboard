...
var historicCity = document.querySelector("#history");
    ...
    cleaningElement(historicCity);
        if(dataStore){
            ...
            for(var i = 0; i < dataStore.length; i++){        
                ...
                historicCity.appendChild(ulElement); 
            }
};
...
var callApiFetch = function(city){
    ...
    var url;
    if (location.protocol === 'http:') {
        url = 'http://api.openweathermap.org/data/2.5/forecast?appid=f6b59cc9b22e29a56938f817554762fb&units=imperial&q='+city;
     } else {
        url = 'https://api.openweathermap.org/data/2.5/forecast?appid=f6b59cc9b22e29a56938f817554762fb&units=imperial&q='+city;
     }
    ...
    .then(function(weatherResponse) {
        ...
        if (weatherResponse.cod != "200") {
            ...
            var url1;
        if (location.protocol === 'http:') {
            url1 = 'http://api.openweathermap.org/data/2.5/uvi?appid=f6b59cc9b22e29a56938f817554762fb&lat='+weatherCondition[0].lat+'&lon='+weatherCondition[0].lon;
        } else {
            url1 = 'https://api.openweathermap.org/data/2.5/uvi?appid=f6b59cc9b22e29a56938f817554762fb&lat='+weatherCondition[0].lat+'&lon='+weatherCondition[0].lon;
        }
